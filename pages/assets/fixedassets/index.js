  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6 bg-slate-900/60 rounded-xl p-6 border border-slate-700 shadow-xl">
        <h1 className="text-2xl font-bold text-white mb-2">Fixed Assets</h1>
        <p className="text-slate-400">Search and manage company Fixed Assets</p>
      </div>
      ...
      <div className="bg-slate-800 rounded-xl p-6 border border-slate-700 shadow-xl min-h-[400px] flex flex-col justify-between">
        <div className="flex-1">
          {!hasInteracted ? (
            ...
            >
              ...
              <p className="text-lg font-semibold text-slate-350">Scroll down, click, or search to load fixed assets</p>
        ...
        {hasInteracted && data.length > 0 && (
          <div ref={loadMoreRef} className="py-6 text-center border-t border-slate-700/30 mt-6">
            {loadingMore ? (
              <span className="text-sm text-cyan-400 font-semibold animate-pulse">Loading more fixed assets...</span>
            ) : hasMore ? (
