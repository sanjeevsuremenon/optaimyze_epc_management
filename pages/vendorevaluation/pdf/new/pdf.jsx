    ...
    <div className="rounded-3xl bg-white p-6 shadow-xl ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-700">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-2xl bg-slate-50 p-4 dark:bg-slate-800">
          <p className="text-sm uppercase tracking-[0.18em] text-slate-400">From vendor code</p>
          <p className="mt-2 text-xl font-semibold text-slate-900 dark:text-slate-100">
            {filters?.vendorCodeFrom ?? "N/A"}
          </p>
        </div>
        <div className="rounded-2xl bg-slate-50 p-4 dark:bg-slate-800">
          <p className="text-sm uppercase tracking-[0.18em] text-slate-400">To vendor code</p>
          <p className="mt-2 text-xl font-semibold text-slate-900 dark:text-slate-100">
      ...
      <div className="mt-8 rounded-3xl border border-slate-200 bg-slate-50 p-6 text-slate-700 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300">
