        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-app-text ${errors.poReference ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'}`}
              required
              autoComplete="off"
