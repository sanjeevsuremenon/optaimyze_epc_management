      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <input type="text" name="title" value={formData.title} onChange={handleInputChange} className={`w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-app-text ${errors.title ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'}`} required />
            {errors.title && <p className="mt-1 text-sm text-red-600">{errors.title}</p>}
          </div>
          <div>
            <label className="block text-sm font-medium mb-2">Priority *</label>
            <select name="priority" value={formData.priority} onChange={handleInputChange} className={`w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-app-text ${errors.priority ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'}`} required>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-app-text ${errors.prNumber ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'}`}
              required
              autoComplete="off"
          ...
          <div>
            ...
            <textarea name="requestInfo" value={formData.requestInfo} onChange={handleInputChange} className={`w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-app-text ${errors.requestInfo ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'}`} rows={3} required />
